 ...
 * Skills/MCP from `pi inspect` with enable toggles (extensions.json / ACP inject).
 * Plugins from `pi plugin list/install/update/…` (config.toml disabled list).
 */
...
export function ExtensionsPanel({
  ...
  /** Pi CLI Plugins tab filter: all | enabled | disabled */
  ...
  return (
    <div className="ext-panel" data-testid="extensions-panel">
      ...
      {/* Plugins — same inventory as Pi CLI `plugin list` / Plugins tab */}
