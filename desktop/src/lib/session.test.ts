...
describe("session projection", () => {
  ...
  it("reconciles optimistic ids with persisted journal ids without duplicates", () => {
    const cached: ChatMessage[] = [
      {
        id: "u-optimistic",
        role: "user",
        content: "Describe this screenshot",
        createdAt: "2026-07-26T12:43:25.640Z",
        attachments: [
          { path: "/tmp/screenshot.png", name: "screenshot.png", isDir: false },
        ],
      },
      {
        id: "a-stream",
        role: "assistant",
        content: "The screenshot shows a terminal.",
        createdAt: "2026-07-26T12:43:41.290Z",
      },
    ];
    const stored: ChatMessage[] = [
      {
        ...
        role: "user",
        content: "Describe this screenshot",
        createdAt: "2026-07-26T12:43:25.645Z",
        attachments: [
          { path: "/tmp/screenshot.png", name: "screenshot.png", isDir: false },
        ],
      },
      {
        ...
        role: "assistant",
        content: "The screenshot shows a terminal.",
        createdAt: "2026-07-26T12:43:41.294Z",
      },
    ];
    ...
    expect(out[0]?.attachments?.[0]?.path).toBe("/tmp/screenshot.png");
  });

  it("preserves intentional repeated messages by matching multiplicity", () => {
    const stored: ChatMessage[] = [
      {
        id: "u-journal",
        role: "user",
    ...
    const cached: ChatMessage[] = [
      {
        ...
        role: "user",
        content: "repeat",
        createdAt: "2026-07-26T12:00:01Z",
      },
      {
        id: "u-second",
        role: "user",
